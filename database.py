...
def init_db():
    with get_conn() as conn:
        ...
        default_statuses = [
            ...
            "🕊️ Peace and quiet, delivered",
            "🌑 Absolute stillness",
            "🫥 Nothing to hear here",
            "💭 Listening to the sound of nothing",
            "🧘 Meditating in your VC",
            "🫧 Floating in the void",
            "🕯️ Burning in comfortable silence",
            "🌙 Just a quiet presence",
            "🫀 Your heartbeat is louder than this",
            "👻 Haunting your VC silently",
            "🔕 Do not disturb",
            "🧂 Seasoning the silence",
            "💤 You won't even know I'm here",
            "🪨 Still as a stone",
            "🫣 Hiding in plain sight",
            "🌿 Breathing with the room",
            "🐾 Sneaking through your VC undetected",
        ]
        conn.executemany(
